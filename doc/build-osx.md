# Mac OS X Signatumclassicd Build Instructions
...
* See readme-qt.rst for instructions on building Signatumclassic QT, the
...
## Building Signatumclassic

    git clone https://github.com/signatumclassicd/source signatumclassic
    cd signatumclassic/src
    make -f makefile.osx

## Useful commands

    ./signatumclassicd --help  # for a list of command-line options.
    ./signatumclassicd -daemon # to start the signatumclassic daemon.
    ./signatumclassicd help    # When the daemon is running, to get a list of RPC commands
